...
namespace UL.Selenium.Portal.RPS.Steps
{
	...
	class Steps_Navigation
	{
        ...
        [StepDefinition(@"I click the main tab: (.*)")]
		...
		[StepDefinition(@"I click the tab: (.*) with parameter IsWebViewer: (.*)")]
		...
		[StepDefinition(@"I confirm that the (.*) tab is active")]
		...
		[StepDefinition(@"I confirm that the (.*) tab is active with WebViewer param: (.*)")]
        ...
        [StepDefinition(@"In the Product Lookup page I confirm the search box is shown")]
        ...
        [StepDefinition(@"In the footer area I see the following:")]
        ...
        [StepDefinition(@"In the Status webview page I confirm the search box is shown")]
        ...
        [StepDefinition(@"I confirm Status webviewer page, I confirm background color is: grey")]
        ...
        [StepDefinition(@"In the product grid I confirm I see the following columns:")]
        ...
        [StepDefinition(@"In the Product Grid Product Info Column I see the following information:")]
        ...
        [StepDefinition(@"In the Product Grid the following field: (.*) has the following font color: (.*) and the following font weight: (.*)")]
        ...
        [StepDefinition(@"In the Status webview page I confirm the search box text reads: (.*)")]
        ...
        [StepDefinition(@"In the Status webview page I confirm to the right of the buttons I see three trends")]
        ...
        [StepDefinition(@"In the Status webview page I confirm below the filters and trend graphics I see the product grid")]
        ...
        [StepDefinition(@"In the Status webview page I confirm the main table heading row background color is grey")]
        ...
        [StepDefinition(@"In the Status webview page I confirm below the Product grid the page footer is shown")]
        ...
        [StepDefinition(@"In the Product Lookup page I confirm the to the right of the search box I see the following buttons:")]
        ...
        [StepDefinition(@"In the Product Lookup page I confirm to the right of the buttons I see three trends")]
        ...
        [StepDefinition(@"In the Product Lookup page I confirm below the filters and trend graphics I see the product grid")]
        ...
        [StepDefinition(@"In the Product Lookup page I confirm the main table heading row background color is grey")]
        ...
        [StepDefinition(@"In the Product Lookup page I confirm data rows are shown")]
        ...
        [StepDefinition(@"In the Product Lookup page I confirm below the Product grid the page footer is shown")]
        ...
        [StepDefinition(@"In the Status webview page I confirm the to the right of the search box I see the following buttons:")]
        ...
        [StepDefinition(@"In the Status webview page I confirm data rows are shown")]
		...
		[StepDefinition(@"I Confirm that the tab: (.*) is  shown in white highlight indicating it is inactive")]
		...
		[StepDefinition(@"I confirm the following drop down options are displayed below the navigation bar Web viewers button:")]
        ...
        [StepDefinition(@"I click Accept all Cookies")]
        ...
        [StepDefinition(@"I Confirm that the tab: (.*) shows in a white highlight indicating it is active")]
        ...
        [StepDefinition(@"I Confirm that the tab: (.*) shows in a bolded underline under text indicating it is active")]
        ...
        [StepDefinition(@"I Confirm that the tab: (.*) does not show in a bolded underline under text indicating it is inactive")]
