...
#^Add location check to manual step (below header)
Then I Confirm the Help & Support Popup contains the Need an Ingredient area
#^Add location check to manual step (below header)
Then In the Help & Support Popup I Check that the mouse can drag the scroll bar up and down
