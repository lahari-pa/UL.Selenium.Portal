...
namespace UL.Selenium.Portal.RPS.Selenium_Classes
{
    public class ItemSync : WidgetPage
    {
        ...
        private IWebElement UPCInputBox => this.containerElement.FindElement(By.XPath(".//input[@id='upcStringCandidate']"), 2);
        public IWebElement UPCInputAddButton => this.containerElement.FindElement(By.XPath(".//button[@data-bind='enable: upcStringArray().length < maxUPCs' and text()='Add']"), 2);

        private IWebElement UPCInputWarningElement => this.containerElement.FindElement(By.XPath(".//span[@class='text-danger']"), 2);

        private IWebElement MainTextBox => this.containerElement.FindElement(By.XPath($"//div[@class='jumbotron']//p"), 5);

        private IWebElement UploadBoxSection => this.containerElement.FindElement(By.XPath($"//div[@class='jumbotron']//div[@data-url='/Data/ItemSyncFile']"), 5);
        ...
        private IWebElement UPCInputError => this.containerElement.FindElement(By.XPath(".//form[@class='form-inline']//div//span[2]"), 2);

        private IWebElement UPCDetailsResultsTable => this.containerElement.FindElement(By.XPath($"//div[@id='item-sync-page']//table"), 5);

        private IWebElement ActionButtonsSection => this.containerElement.FindElement(By.XPath(".//div[@class='form-inline']"), 2);
