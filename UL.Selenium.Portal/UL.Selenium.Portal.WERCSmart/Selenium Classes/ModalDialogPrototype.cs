...
namespace UL.Selenium.Portal.WERCSmart.Selenium_Classes
{
	...
	public class QuestionFormGroup(IWebElement containerElement)
	{
		...
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group Validation Glyphicon exists.");
			return this.ValidationGlyphicon != null;
		}

		public bool ValidationGlyphiconDisplayed()
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group Validation Glyphicon is displayed.");
			return this.ValidationGlyphicon.Displayed;
		}

		public bool ValidationGlyphiconIsType(string type)
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group Validation Glyphicon is '{type}' type.");
		...
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group Checkbox Options list exists.");
			return !this.CheckboxOptionsList.IsNullOrEmpty();
		}
		public List<string> CheckboxOptionsListLabelsList()
		{
			Report.Info($"Attempting to get '{this.Label}' Question Form Group Checkbox options label list");
			return [.. this.CheckboxOptionsList.Select(x => x.Label)];
		}

		public bool CheckboxOptionByLabelExists(string optionLabel)
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group '{optionLabel}' Checkbox Option exists.");
		...
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group Dropdown input exists.");
			return this.DropdownInput != null;
		}

		public bool DropdownInputClick()
		{
			Report.Info($"Attempting to click '{this.Label}' Question Form Group Dropdown input.");
			return this.DropdownInput.TryClick();
		}

		public string DropdownInputValue()
		{
			Report.Info($"Attempting to get '{this.Label}' Question Form Group Dropdown input value.");
			return this.DropdownInput.GetValue();
		}

		public List<string> DropdownOptionsLabelsList()
		{
			Report.Info($"Attempting to get '{this.Label}' Question Form Gropup Dropdown Options labels list.");
			return [.. this.DropdownOptionsList.Select(x => x.Text.Trim())];
		}

		public bool DropdownOptionExists(string optionLabel)
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group '{optionLabel}' Dropdown Option exists.");
			return this.DropdownOption(optionLabel) != null;
		}

		public bool DropdownOptionClick(string optionLabel)
		{
			Report.Info($"Attempting to confirm '{this.Label}' Question Form Group '{optionLabel}' Dropdown Option.");
