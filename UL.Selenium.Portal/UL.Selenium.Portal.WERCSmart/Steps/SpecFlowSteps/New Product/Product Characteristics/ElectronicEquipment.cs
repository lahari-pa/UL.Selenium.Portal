...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Type
{
	...
	{
		[RegexStepDefinition(@"In the Electronic Equipment Section, set the option in section: 'Contains Circuit Board' to: (Yes|No)")]
		public void SetContainsCircuitBoard(string option)
		{
			string section = "Contains Circuit Board";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[RegexStepDefinition(@"In the Electronic Equipment Section, set the option in section: 'Has a LCD or Plasma Display' to: (Yes|No)")]
		public void SetHasLCDorPlasmaDisplay(string option)
		{
			string section = "Has a LCD or Plasma Display";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[RegexStepDefinition(@"In the Electronic Equipment Section, set the option in section: 'Display is greater than 4 inches diagonally' to: (Yes|No)")]
		public void SetDisplayIsGreaterThan4Inches(string option)
		{
			string section = "Display is greater than 4 inches diagonally";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[RegexStepDefinition(@"In the Electronic Equipment Section, set the option in section: 'Display is greater than 9 inches diagonally' to: (Yes|No)")]
		public void SetDisplayIsGreaterThan9Inches(string option)
		{
			string section = "Display is greater than 9 inches diagonally";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[RegexStepDefinition(@"In the Electronic Equipment Section, set the option in section: 'Has a Cathode Ray Tube \(CRT\)' to: (Yes|No)")]
