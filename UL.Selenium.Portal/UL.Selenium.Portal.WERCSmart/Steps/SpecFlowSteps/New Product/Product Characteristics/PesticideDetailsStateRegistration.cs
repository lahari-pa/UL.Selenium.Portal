...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product
{
	...
	{
		[RegexStepDefinition(@"In the Pesticide Details - State Registration Details Section, click 'Update WERCSmart data with EPA data through Kelly Solutions' link")]
		...
		[RegexStepDefinition(@"In the Pesticide Details - State Registration Details section, set the following date: (.*) for the state: (.*)")]
		...
		[RegexStepDefinition(@"In the Pesticide Details - State Registration Details section, select the status: (Registered|Restricted, Not Registered|No State Registration Required|Pending State Registration) for the state: (.*)")]
		...
		[RegexStepDefinition(@"In the Pesticide Details - State Registration Details section, verify State Expiration Date is prefilled for the state: (.*)")]
		...
		[RegexStepDefinition(@"In the Pesticide Details - State Registration Details section, verify the status: (Registered|Restricted, Not Registered|No State Registration Required|Pending State Registration) is selected for the state: (.*)")]
		...
		[RegexStepDefinition(@"In Pesticide Details - State Registration Details page I verify row color highlighting indicates item is expiring in less then (31|90) for state: (.*)")]
		...
		[RegexStepDefinition(@"In Pesticide Details - State Registration Details section I verify check mark in Expiration Imported column (is|is not) displayed for state: (.*)")]
		...
		[RegexStepDefinition(@"In the Pesticide Details - State Registration Details section, select the status: (Registered|Restricted, Not Registered|No State Registration Required|Pending State Registration) for all states with no status preselected")]
		...
		[RegexStepDefinition(@"In the Pesticide Details - State Registration Details section, click 'Select All' for the status: (Registered|Restricted, Not Registered|No State Registration Required|Pending State Registration) for all states")]
