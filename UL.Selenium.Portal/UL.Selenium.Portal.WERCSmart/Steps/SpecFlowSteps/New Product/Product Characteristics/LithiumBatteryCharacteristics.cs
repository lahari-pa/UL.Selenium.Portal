...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product
{
	...
	{
		[RegexStepDefinition(@"In the Lithium Battery Characteristics Section, in 'Type of Battery' select (.*)")]
		...
		[RegexStepDefinition(@"In the Lithium Battery Characteristics Section, in 'Weight of Lithium in grams' enter (.*)")]
		...
		[RegexStepDefinition(@"In the Lithium Battery Characteristics Section, in 'Weight of the single unit' enter (.*)")]
		public void SelectWeightOFSingleUnit(string option)
		{
			string section = "Weight of the single unit (grams)";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[RegexStepDefinition(@"In the Lithium Battery Characteristics Section, in 'Battery is manufactured under a Quality Management Program outlined in IATA 3.9.2.6' enter (YES|No|Unknown)")]
		...
		[RegexStepDefinition(@"In the Lithium Battery Characteristics Section, in 'Watt-hour of the battery' enter (.*)")]
