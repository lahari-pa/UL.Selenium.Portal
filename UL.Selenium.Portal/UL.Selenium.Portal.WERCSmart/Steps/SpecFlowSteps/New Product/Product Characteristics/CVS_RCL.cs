...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Characteristics
{
	...
	{
		[RegexStepDefinition(@"I enter the text of what is the CVS merchandising category for this product field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of who is the Product Development Manager (PDM) for this product field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of Indicate the brand field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of Indicate your Product Development Manager field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of Indicate your Product Category field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of CVS Store Brand associated to this product field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of Select the options that appear on the label field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of Is this product intended to be rinsed off after use field to: (Yes|No)")]
		...
		[RegexStepDefinition(@"I enter the text of Is this product intended to be ingested field to: (Yes|No)")]
		...
		[RegexStepDefinition(@"I enter the text of This product a personal care sanitizer- wash- or cleanser field to: (Yes|No)")]
		...
		[RegexStepDefinition(@"I enter the text of list the label claims for the product field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of list the foreseeable mis-uses for the product field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of select all body parts where the product may be applied field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of requency of Product Application over 24 hours field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of How is the product applied field to: (.*)")]
		...
		[RegexStepDefinition(@"I upload the following PDF to section named Upload Full Product Label: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of Other field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of HR 1321 field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of Contact your CVS Product Development Manager field to: (.*)")]
		...
		[RegexStepDefinition(@"I enter the text of CVS Brand Registration Continue Question field to: (.*)")]
