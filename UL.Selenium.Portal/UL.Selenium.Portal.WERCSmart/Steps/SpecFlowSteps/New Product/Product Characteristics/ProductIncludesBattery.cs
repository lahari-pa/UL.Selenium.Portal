...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product
{
	...
	{
		[RegexStepDefinition(@"In the Product Includes Battery Section, set the radio option in section: 'Indicate how battery is packaged': to: (Installed in the product|The battery is shipped with but not included in my product.|Installed in the Product and Shipped with Additional Batteries not within the Product.)")]
		...
		[RegexStepDefinition(@"In the Product Includes Battery Section, the text message (should|should not) be displayed with text: 'Product includes a battery when sold'")]
		...
		[RegexStepDefinition(@"In the Product Includes Battery Section enter value (.*) in (Battery Type|Grams Lithium|Watt Hours) field")]
		...
		[RegexStepDefinition(@"In the Product Includes Battery Section enter value (.*) in (Quantity of Batteries per Package|Quantity of Batteries to Operate Product) field")]
		...
		[RegexStepDefinition(@"In the Product Includes Battery Section enter value (.*) in 'Manufacturer' field")]
		...
		[RegexStepDefinition(@"In the Product Includes Battery Section enter the values in the table:")]
