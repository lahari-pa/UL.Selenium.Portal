...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Characteristics
{
	...
	{
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, set the option in section: 'UN Number': to: (.*)")]
		...
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, set the option in section: 'Technical Name \(if applicable\)': to: (.*)")]
		...
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, set the option in section: 'Packing Group': to: (.*)")]
		public void SetPackingGroupIMDG(string option)
		{
			string section = "Packing Group (select)";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, I confirm checkbox 'Copy information from my U.S. Department of Transportation data' (should|should not) be displayed")]
		...
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, I (check|uncheck) checkbox 'Copy information from my U.S. Department of Transportation data'")]
		...
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, set the option in section: 'Special Provision Number': to: (.*)")]
		public void SetSpecialProvisionNumber(string option)
		{
			string section = "Special Provision Number";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, set the option in section: 'Regulatory reference for any exemption or exceptions taken': to: (.*)")]
		...
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, verify section: 'Proper Shipping Name' contains value: (.*)")]
		public void VerifyProperShippingNameIMDG(string value)
		{
			string section = "Proper Shipping Name";
			new Steps_Prototype().CheckingFieldInputIsCorrect(section, value);
		}
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, verify section: 'Technical Name \(if applicable\)' contains value: (.*)")]
		...
		[StepDefinition(@"In the International Marine \(IMDG\) Classification Section, verify section: 'Packing Group \(select\)' contains value: (.*)")]
