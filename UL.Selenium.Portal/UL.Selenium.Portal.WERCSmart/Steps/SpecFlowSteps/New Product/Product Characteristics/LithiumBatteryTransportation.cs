...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Characteristics
{
	...
	class WERCSmart_Distributor_NewProducts_LithiumBatteryTransportation
	{
		...
		[RegexStepDefinition(@"In the Lithium Battery Transportation Section, the text message (should|should not) be displayed with text: 'Need help\? Regulatory services are included in Premium Subscription. Upgrade now\!'")]
		...
		[RegexStepDefinition(@"In the Lithium Battery Transportation Section, the text message (should|should not) be displayed with text: 'Confirm that this product is manufactured in a facility that meets criteria outline in IATA 3.9.2.6€.'")]
