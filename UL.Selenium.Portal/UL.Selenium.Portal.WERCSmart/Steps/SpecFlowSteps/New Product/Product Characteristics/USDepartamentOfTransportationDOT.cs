...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Characteristics
{
	...
	{
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'UN Number': to: (.*)")]
		public void SetUNNumberIMDG(string option)
		{
			string section = "UN Number";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'Proper Shipping Name': to: (.*)")]
		public void SetProperShippingNameIMDG(string option)
		{
			string section = "Proper Shipping Name";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'Technical Name \(if applicable\)': to: (.*)")]
		public void SetTechnicalNameIMDG(string option)
		{
			string section = "Technical Name (if applicable)";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'Hazard Class': to: (.*)")]
		public void SetHazardClassIMDG(string option)
		{
			string section = "Hazard Class (select)";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'Packing Group': to: (.*)")]
		public void SetPackingGroupIMDG(string option)
		{
			string section = "Packing Group (select)";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'Special Provision Number': to: (.*)")]
		public void SetSpecialProvisionNumber(string option)
		{
			string section = "Special Provision Number";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'Regulatory reference for any exemption or exceptions taken': to: (.*)")]
		...
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, set the option in section: 'For the lighter, provide the DOT Approval Number \(LAA\)': to: (.*)")]
		...
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, verify section: 'Proper Shipping Name' contains value: (.*)")]
		public void VerifyProperShippingNameIMDG(string value)
		{
			string section = "Proper Shipping Name";
			new Steps_Prototype().CheckingFieldInputIsCorrect(section, value);
		}
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, verify section: 'Technical Name \(if applicable\)' contains value: (.*)")]
		...
		[StepDefinition(@"In the U. S. Department of Transportation \(DOT\) Classification Section, verify section: 'Packing Group \(select\)' contains value: (.*)")]
