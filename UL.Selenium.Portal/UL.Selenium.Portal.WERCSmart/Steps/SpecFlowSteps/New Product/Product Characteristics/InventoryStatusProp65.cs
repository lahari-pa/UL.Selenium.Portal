...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product
{
	namespace UL.Selenium.Portal.WERCSmart.Steps
	{
		...
		class WERCSmart_Distributor_NewProducts_InventoryStatusProp65
		{
			...
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, set the radio option in section: 'Is the need to warn triggered by' to: (A chemical or chemicals in the product, or chemicals formed during the use of the product.|A chemical or chemicals in the packaging.|A chemical or chemicals in both the product and packaging.)")]
			public void SelectIsNeedToWarnTriggeredBy(string option)
			{
				string section = "Is the need to warn triggered by";
				new Steps_Prototype().SetRadioOptionInSectionTo(section, option);
			}
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, set the radio option in section: 'How is the exposure warning transmitted\?' to: (By affixing it to the product or its packaging|By providing warning materials \(labels, shelf signage, online warning language\) to a retailer’s authorized agent|Other \(Please specify\))")]
			...
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, enter value in 'Other' field for section: 'How is the exposure warning transmitted\?': (.*)")]
			...
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, set the radio option in section: 'If the product carries a safe-harbor short-form warning- indicate which of the following is provided:': to: (WARNING: Cancer -|WARNING: Reproductive Harm -|WARNING: Cancer and Reproductive Harm -|Does not apply)")]
			...
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, enter value in 'Enter the names of one or more listed carcinogens which are the subject of this warning' section: (.*)")]
			...
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, enter value in 'Enter the names of one or more listed reproductive or developmental toxicants which are the subject of this warning:' section: (.*)")]
			...
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, enter value in 'Enter the names of one or more listed chemicals that are both carcinogens and reproductive or developmental toxicants which are the subject of this warning:' section: (.*)")]
			...
			[StepDefinition(@"In the Inventory Status, Prop 65 \(US\) Section, enter value in 'If the product carries a custom warning, please provide the exact text that is being used:' section: (.*)")]
