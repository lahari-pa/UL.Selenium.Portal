...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Characteristics
{
	...
	{
		[StepDefinition(@"In the Pesticide Details - Canada Section, set the option in section: 'Product\'s packaging includes a Poison Danger symbol': to: (Yes|No)")]
		...
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Alberta': to: (.*)")]
		public void SetOptionForAlberta(string option)
		{
			string section = "Alberta";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'British Columbia': to: (.*)")]
		public void SetOptionForBritishColumbia(string option)
		{
			string section = "British Columbia";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Manitoba': to: (.*)")]
		public void SetOptionForManitoba(string option)
		{
			string section = "Manitoba";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'New Brunswick': to: (.*)")]
		public void SetOptionForNewBrunswick(string option)
		{
			string section = "New Brunswick";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'New Foundland and Labrador': to: (.*)")]
		public void SetOptionForNewFoundlandandLabrador(string option)
		{
			string section = "New Foundland and Labrador";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Nova Scotia': to: (.*)")]
		public void SetOptionForNovaScotia(string option)
		{
			string section = "Nova Scotia";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Ontario': to: (.*)")]
		public void SetOptionForOntario(string option)
		{
			string section = "Ontario";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Prince Edward Island': to: (.*)")]
		public void SetOptionForBritishPrinceEdwardIsland(string option)
		{
			string section = "Prince Edward Island";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Quebec': to: (.*)")]
		public void SetOptionForQuebec(string option)
		{
			string section = "Quebec";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Saskatchewan': to: (.*)")]
		public void SetOptionForSaskatchewan(string option)
		{
			string section = "Saskatchewan";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Northwest Territory': to: (.*)")]
		public void SetOptionForNorthwestTerritory(string option)
		{
			string section = "Northwest Territory";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, set option for Province: 'Yukon Territory': to: (.*)")]
		public void SetOptionForYukonTerritory(string option)
		{
			string section = "Yukon Territory";
			new Steps_Prototype().SetTheSectionOptionTo(section, option);
		}
		[StepDefinition(@"In the Pesticide Details - Canada Section, click 'Add Row' button")]
		...
		[StepDefinition(@"In the 'Pesticide Details - Canada' 'Remove Item' modal window (should|should not) be displayed")]
