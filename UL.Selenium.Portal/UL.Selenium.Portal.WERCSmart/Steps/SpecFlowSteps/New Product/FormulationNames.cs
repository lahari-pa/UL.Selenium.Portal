...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product
{
	...
	{
		[RegexStepDefinition(@"In the Formulation Names section, I enter the text of Provide the name\(s\) to be used to identify the formula field to: (.*)")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, I enter the text of Provide Public Name\(s\) of the formula you're registering field to: (.*)")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, I enter the text of cleaning products its Business-to-Consumer field to: (.*)")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, for section: 'Formula Name for the WERCSmart Ingredient Directory' clear the textbox field")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, the section: 'Formula Name for the WERCSmart Ingredient Directory' (should|should not) display an error message: (.*)")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, confirm that the full text for section: 'Provide Public Name\(s\) of the formula you're registering.' (is|is not) displayed")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, confirm that the full text for section: 'Business to Consumer Name' (is|is not) displayed")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, for section: 'Business to Consumer Name' confirm that the textbox displays the shadow text: (.*)")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, for section: 'Business to Consumer Name' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Formulation Names section, the section: 'Business to Consumer Name' (should|should not) display an error message: (.*)")]
