...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Type
{
	...
	class PhysicalAndChemicalProp
	{
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for section: 'Relative Density' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for section: 'pH' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for section: 'pH' select the checkbox option: 'I do not have exact pH data available to me'")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'pH' to: (<= 2|2.1 - 3.9|4 - 6.9|7 \(Neutral\)|7.1 - 9.9|10 - 12.4|>= 12.5|Not tested/Unknown)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for question: 'When mixed with an equal amount of water, will this produce a solution with a pH <= 2 or a pH >= 12.5\?' set the option to: (Yes|No)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for section: 'Boiling Point \(in Celsius\)' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for section: 'Boiling Point \(in Celsius\)' select the checkbox option: 'I do not have exact Boiling Point data available to me'")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'Boiling Point \(in Celsius\)' to: (<= 20C \(68F\)|20.1C \(68.1F\) - 35C \(95F\)|>35C \(95F\) - 37.7C \(99.9F\)|> 37.7C \(99.9F\)|Not tested/Unknown)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for section: 'Flash Point \(in Celsius\)' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'Flash Point \(in Celsius\)' to: (<23C|>=23C and <38C|>=38C and <=60C|>60C and <=93C|>=93C and <=815C|Not Tested/Unknown|None, No Flash Point)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'Flash Point Testing Method Used' to: (Closed cup method|Open cup method|Not applicable/available)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'Select the best Water Solubility description' to: (Cloth not soluble|Completely soluble|Dispersible|Immiscible|Insoluble in water|Miscible|Miscible in water|Moderately soluble|Mostly soluble|Negligible|No data available|Partially soluble|Soluble in water)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'When the product has a flammable propellant, or contains ingredients with a flash point below 60⁰C then' to: (This product is classified as a D001 Hazardous Waste under RCRA \(as per Section 13 or 15 of the SDS\).|This product is classified as a D003 Hazardous Waste under RCRA.|This product is not classified as D001 or D003 Hazardous Waste under RCRA)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'Select all potential allergens included in this product' to: (Dairy|Egg|Wheat|Peanuts|Tree Nuts|Soybeans|Shellfish or Crustaceans|None of the Above)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'Product is verified and sold as' to: (Kosher|Gluten-free|Halal|Genetically Modified Organisms \(GMOs\)-free|Organic per USDA Standards|Non-Perishable|None of the Above)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, set the option in section: 'Product contains the following sweeteners' to: (Saccharin|Aspartame|Acesulfame potassium|Advantame|Steviol glycosides|Luo han guo fruit extracts|Sucralose|Neotame|None of the Above)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, for section: 'Flash Point Testing Method Used': the following options (should|should not) be (displayed|displayed exclusively):")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the section: 'Primary Physical State' should be showing the option: (Product is packaged in a gas cylinder \(e.g., whip cream\)|Liquid|Solid|Gas|Aerosol)")]
		public void CheckOptionsInPrimaryPhysicalStateSection(string option)
		{
			string section = "Primary Physical State";
			new Steps_Prototype().CheckingFieldInputIsCorrect(section, option);
		}

		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the section: 'Primary Physical State' confirm option (is|is not) selected: (Product is packaged in a gas cylinder \(e.g., whip cream\)|Liquid|Solid|Gas|Aerosol)")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the confirm section: 'Secondary Physical State' (is|is not) displayed")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the confirm section: 'When mixed with an equal amount of water, will this produce a solution with a pH <=2 or a pH >=12.5\?' (is|is not) displayed")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the confirm section: 'Relative Density' (is|is not) displayed")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the confirm section: 'pH' (is|is not) displayed")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the confirm section: 'Boiling Point \(in Celsius\)' (is|is not) displayed")]
		...
		[RegexStepDefinition(@"In the Physical and Chemical Properties Section, the confirm section: 'Flash Point \(in Celsius\)' (is|is not) displayed")]
