...
namespace UL.Selenium.Portal.WERCSmart.Steps
{
	...
	class WERCSmart_Distributor_NewProducts_ProductType_TheProduct
	{
		...
		[StepDefinition(@"In the Product Section, set the option in section: 'Product Line or Brand \(optional\)' to: (.*)")]
		...
		[StepDefinition(@"In the Product Section, set the option in section: 'Product Identification \(Optional\)' to: (.*)")]
		...
		[StepDefinition(@"In the Product Section, set the option in section: 'Type of Product \(select\)' to: (.*)")]
