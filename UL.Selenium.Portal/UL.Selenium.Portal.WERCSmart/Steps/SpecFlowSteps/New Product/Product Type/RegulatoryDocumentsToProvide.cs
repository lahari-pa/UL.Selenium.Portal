...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Product_Type
{
	...
	{
		[StepDefinition(@"In the Regulatory Documents to Provide Section, set the option in section: 'OSHA-compliant Safety Data Sheet, English' to: (Yes, I certify that I have an OSHA-compliant SDS for this product and would like to upload it.|Request to author)")]
