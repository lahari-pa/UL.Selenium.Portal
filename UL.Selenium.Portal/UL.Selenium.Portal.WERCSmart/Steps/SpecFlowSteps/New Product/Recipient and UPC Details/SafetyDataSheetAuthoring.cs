...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Recipient_and_UPC_Details
{
	...
	class SafetyDataSheetAuthoring
	{
		...
		[RegexStepDefinition(@"In the Safety Data Sheet Authoring - Additional Data \(Optional\), set the option in section: 'Personal Protection Equipment Recommended \(select\)' to: (Mask|Gloves|Apron|Goggles)")]
		...
		[RegexStepDefinition(@"In the Safety Data Sheet Authoring - Additional Data \(Optional\), for the section: 'Minimum Ignition Energy \(mJ\)' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Safety Data Sheet Authoring - Additional Data \(Optional\), for the section: 'Viscosity' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Safety Data Sheet Authoring - Additional Data \(Optional\), for the section: 'Product's Dispensing Method' select option: (Aerosol|Bag-On-Value|Pump|None of the Above/Not Applicable)")]
