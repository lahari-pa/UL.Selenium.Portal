...
namespace UL.Selenium.Portal.WERCSmart.Steps.SpecFlowSteps.New_Product.Review_and_Submit
{
	...
	public class AdditionalDocsContactInfo_Steps
	{
		...
		[RegexStepDefinition(@"In the Additional Documents -> Contact Information section, for section: 'Manufacturer Name' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Additional Documents -> Contact Information section, for section: 'Address' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Additional Documents -> Contact Information section, for section: 'Emergency Phone' enter text: (.*)")]
		...
		[RegexStepDefinition(@"In the Additional Documents Contact Information section, in the sub section: 'Please provide contact information required to display on SDS\(s\) per region.' enter text for the second 'Address': (.*)")]
		...
		[RegexStepDefinition(@"In the Additional Documents Contact Information section, in the sub section: 'Please provide contact information required to display on SDS\(s\) per region.' enter text for 'Phone' : (.*)")]
		...
		[RegexStepDefinition(@"In the Additional Documents Contact Information section, in the sub section: 'Please provide contact information required to display on SDS\(s\) per region.' enter text for 'Emergency Phone' : (.*)")]
		...
		[RegexStepDefinition(@"In the Additional Documents Contact Information section, in the sub section: 'Please provide contact information required to display on SDS\(s\) per region.' enter text for 'Email' : (.*)")]
		...
		[RegexStepDefinition(@"In the Additional Documents -> Contact Information section, in the sub section: 'Please provide contact information required to display on SDS(s) per region.' click the 'Remove' button")]
		...
		[RegexStepDefinition(@"In the Additional Documents -> Contact Information section, in the sub section: 'Please provide contact information required to display on SDS(s) per region.' click the 'Add Row' button")]
		...
		[RegexStepDefinition(@"In the Additional Documents -> Contact Information section, in the sub section: 'Please go to My Account to manage your SDS emergency contact information for this document format.' click the 'My Account' link")]
