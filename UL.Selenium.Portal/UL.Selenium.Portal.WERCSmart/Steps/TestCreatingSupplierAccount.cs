...
namespace UL.Selenium.Portal.WERCSmart.Steps
{
	internal class TestCreatingSupplierAccount
	{
		...
		public TestCreatingSupplierAccount(string emailSpecialChar)
		{
			...
			this._supplierData.AddRow(MailosaurHelpers.DefaultMailbox.CreateEmail("asdf" + emailSpecialChar + "qwerty"), "UNITED STATES", "WERCS", "Test_Automation", "Welcome1!", "1425 Kingsway", "Address2", "Latham", "New York", "12308", "QA_Automation_Account", "123-456-7889",
