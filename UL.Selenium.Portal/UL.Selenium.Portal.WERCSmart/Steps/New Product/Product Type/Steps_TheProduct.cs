...
namespace UL.Selenium.Portal.WERCSmart.Steps.New_Product.Product_Type
{
	...
	class Steps_TheProduct
	{
		...
		public void SetTypeOfProductTo(string typeOfProduct)
		{
			...
			Report.IsTrue(this.TheProduct.ProductType.Contains(typeOfProduct), "Failed to set Type of Product to: " + typeOfProduct, "Successfully set Type of Product to: " + typeOfProduct);
		}
