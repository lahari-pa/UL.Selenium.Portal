...
Given I confirm the following description is displayed: For all active registrations, a list of the UPCs and Retailers associated.
Then I select CSV from the Select File Type
Given I select the Zip Report Checkbox
...
Given I confirm the following description is displayed: OMSID rejections that may require contacting the retailer to ensure the proper OMSID is associated to the UPC.
Then I select CSV from the Select File Type
Given I select the Zip Report Checkbox
...
Given I click the My Reports icon in the QuickLinks Pane
Given Under the Supplier Reports menu I choose: Kit Registrations
Given I confirm the following description is displayed: For a specific Kit registration, the report will include the individual WERCSmart IDs that are included in the Kit.
Then I select CSV from the Select File Type
Given I select the Zip Report Checkbox
...
Given I confirm the following description is displayed: For a specific WERCSmart ID, the report will show the various Kit registrations that include the specific registration.
Then I select CSV from the Select File Type
Given I select the Zip Report Checkbox
...
Given I click the My Reports icon in the QuickLinks Pane
Given Under the Supplier Reports menu I choose: UPC and Retailer (Single Registration)
Given I confirm the following description is displayed: For a specific WERCSmart registration, the report outlines the retailers and UPCs associated to the registration.
Then I select CSV from the Select File Type
Given I select the Zip Report Checkbox
