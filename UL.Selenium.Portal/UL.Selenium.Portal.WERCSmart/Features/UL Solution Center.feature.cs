...
#line hidden
            ...
            table796.AddRow(new string[] {
                        "Navigator"});
#line 36
 testRunner.Then("I confirm the following sections are displayed in the UL Solution Center page:", ((string)(null)), table796, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 124
 testRunner.Then("I check that the current URL contains: https://psi.ul.com/en/products/ulghs", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
