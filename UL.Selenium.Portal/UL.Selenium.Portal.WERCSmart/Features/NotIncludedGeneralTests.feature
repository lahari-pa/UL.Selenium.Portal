...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSHBExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSArtistExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSCleaningExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSHomeExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSLawnGardenExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSMiscExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSNutritionalExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSOTCExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSPetCareExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSSportingGoodsExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSStationeryExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSBatteryExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSGroceryExcelFile
...
Then I navigate to the Data Consent Tiers Page for CVS
And I Check that The expected data tiers for CVS are the only ones present in the Data Consent Tiers Section
When I click the Products in Scope button and confirm that an excel file is produced called CV_Report_DataUsageTier_<Date>.xlsx and save as CVSPharmacyExcelFile
