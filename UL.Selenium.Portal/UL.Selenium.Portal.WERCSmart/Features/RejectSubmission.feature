...
Scenario: [143638] Reject Submission - Product Name is Unclear
	...
	And I close alert
	Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: <sitenotification> with the title: Notification - Product <ID> - Product Name is Unclear
...
Scenario: [143386] Reject Submission - Document (Safety Data Sheet) is not Compliant with UN Globally Harmonized Standard (GHS)
	...
	Given For product saved as: ID I should see an alert with the following message: Product Message for product ID has been created successfully
	And I close alert
	Given For product saved as: ID there should be a new email for email Address saved in TReVor as: ProductAccount from: <sitenotification> with the title: Notification - Product <ID> - Document (Safety Data Sheet) is not Compliant with UN Globally Harmonized Standard (GHS)
...
Scenario: [143499] Reject Submission - Transportation Information – Missing Base Classification before Exemption or Exception
	...
	Given For product saved as: ID I should see an alert with the following message: Product Message for product ID has been created successfully.
	And I close alert
	Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: <sitenotification> with the title: Notification - Product <ID> - Transportation Information – Missing Base Classification before Exemption or Exception
...
Scenario: [143507] Reject Submission - Volatile Organic Compound (VOC) Issue within Registration
	...
	Given For product saved as: ID I should see an alert with the following message: Product Message for product ID has been created successfully.
	And I close alert
	Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: <sitenotification> with the title: Notification - Product <ID> - Volatile Organic Compound (VOC) Issue within Registration
...
Scenario: [143390] Reject Submission - Flash Point - Safety Data Sheet (SDS) or Article Information Sheet (AIS) Discrepancy
	...
	Given For product saved as: ID I should see an alert with the following message: Product Message for product ID has been created successfully.
	And I close alert
	Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: <sitenotification> with the title: Notification - Product <ID> - Flash Point - Safety Data Sheet (SDS) or Article Information Sheet (AIS) Discrepancy
