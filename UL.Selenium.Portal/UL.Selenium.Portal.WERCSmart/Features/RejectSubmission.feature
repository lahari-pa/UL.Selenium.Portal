...
And I close alert
Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: noreply@wercsmart.ul.com with the title: Notification - Product <ID> - Product Name is Unclear
...
Given For product saved as: ID I should see an alert with the following message: Product Message for product ID has been created successfully.
And I close alert
Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: noreply@wercsmart.ul.com with the title: Notification - Product <ID> - Transportation Information – Missing Base Classification before Exemption or Exception
...
Given For product saved as: ID I should see an alert with the following message: Product Message for product ID has been created successfully.
And I close alert
Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: noreply@wercsmart.ul.com with the title: Notification - Product <ID> - Ingredient Issue - Document and Ingredients Do Not Match
...
Given For product saved as: ID I should see an alert with the following message: Product Message for product ID has been created successfully.
And I close alert
Given For product saved as: ID there should be a new email for email Address saved as: AdminEmailAddress from: noreply@wercsmart.ul.com with the title: Notification - Product <ID> - Volatile Organic Compound (VOC) Issue within Registration
