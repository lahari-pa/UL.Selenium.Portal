...
Scenario: [287238] WERCSmart Portal - Flow Test for Hair Styling Product - Mousse (Aerosol) (RU000669) - Includes Negative Steps
	 ...
	 Then In the Physical and Chemical Properties section, for field 'pH' error message 'pH must be between 1-14 (1 decimal place allowed).' is not displayed
	 Then In the Physical and Chemical Propertiessection, for field 'Select the best Water Solubility description' error message 'This is a required field.' is displayed
	 Then In the Physical and Chemical Properties Section, set the option in section: 'Select the best Water Solubility description' to: Soluble in water
	 Then In the Physical and Chemical Propertiessection, for field 'When the product has a flammable propellant, or contains ingredients with a flash point below 60⁰C then' error message 'This is a required field.' is displayed
	 Then In the Physical and Chemical Properties Section, set the option in section: 'When the product has a flammable propellant, or contains ingredients with a flash point below 60⁰C then' to: This product is classified as a D003 Hazardous Waste under RCRA
	 Then in the Physical and Chemical Properties page, I click Continue
	 ...
	 Given I should be on the Ingredients Page
	 Then in the Ingredients page, I click Continue
	 Then In the Ingredients section, for field 'pH' error message 'This is a required field.' is displayed
