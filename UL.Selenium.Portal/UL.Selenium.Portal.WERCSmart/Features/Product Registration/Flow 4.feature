...
Scenario: [57950] Conditioner - Leave In (RU001272) 4-L
	...
	Then In the Purchase Summary Page, verify 'Item Description' shows Product's Name: Conditioner - Leave In (Liquid, Non Aerosol) and product ID saved as: TestCase57950
