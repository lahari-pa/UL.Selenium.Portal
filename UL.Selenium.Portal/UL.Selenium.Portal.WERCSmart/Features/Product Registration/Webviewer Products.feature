...
Given I call Shared Step 49841 (SHA - Search for exact WPS ID in Assigned Status for saved as: TestCase144967)
...
Given I call Shared Step 79500 (WPS Studio - PD+ - set all data and publish using rule and doc queue - CKLT and SBCS only) for product saved as: TestCase144967
...
| <All>    |
Given I call Shared Step 49841 (SHA - Search for exact WPS ID in All Status for saved as: TestCase144967)
Given In the SHA manager grid I see the WPS ID I have saved as product: TestCase144967 and its status is: Completed
