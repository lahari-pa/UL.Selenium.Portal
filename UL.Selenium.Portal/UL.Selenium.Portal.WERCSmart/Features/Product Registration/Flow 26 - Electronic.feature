...
Given I call Shared Step 48369 Toxicity Characteristic Leaching Procedure (TCLP) - select No to all with Copper - Click Continue - Happy Path

Given I call Shared Step 58189 Answer Electronic Equipment questions - With Cathode Ray - No to all

Given I call Shared Step 150905 (Retailer - NR selected by default - Click Continue - Happy Path)

Given I call Shared Step 57883 (Optional Comments - Happy Path) and enter the comment: Comment Text

Given I call Shared Step 73956 (Go to Summary and verify data) with product type: Computer (Combination of Monitor & Desktop)

Given I call Shared Step 43758 (Product Grid- Filter for Product- Select Product - Delete) for product: TestCase60671
