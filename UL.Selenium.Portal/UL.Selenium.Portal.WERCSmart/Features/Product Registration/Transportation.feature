...
Scenario: [65754] Transportation - Copy information from my U.S. Department of Transportation data check box &  IATA data
	 ...
	 And In the International Air Transport (IATA) Classification Section, verify section: 'UN Number' contains value: UN1950
	...
	And In the International Air Transport (IATA) Classification Section, verify section: 'Technical Name (if applicable)' contains value: Technical Test Name
	#And Hazard Class (select) should be showing the value: 2.1
	And In the International Air Transport (IATA) Classification Section, verify section: 'Hazard Class (select)' contains value: 2.1
