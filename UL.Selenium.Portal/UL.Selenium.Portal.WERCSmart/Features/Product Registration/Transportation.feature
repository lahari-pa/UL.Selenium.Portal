...
#Given I call Shared Step 23195 (Login into WERCSmart Portal - Administrator Role)
 ...
 And I should be on the International Air Transport (IATA) Classification Page
...
#And I click continue
And Then in the Canada - Transportation of Dangerous Goods (TDG) Classification page, I click Continue
#And Copy information from my U.S. Department of Transportation data should not be showing any error messages
#And Technical Name (if applicable) should not be showing any error messages
#And UN Number should be showing the error messages: This is a required field.
#And Proper Shipping Name should be showing the error messages: This is a required field.
...
Scenario: [65754] Transportation - Copy information from my U.S. Department of Transportation data check box &  IATA data
 ...
 And In the International Air Transport (IATA) Classification Section, verify section: 'UN Number' contains value: UN1970
 #And Proper Shipping Name should be showing the value: Choose...
 And In the International Air Transport (IATA) Classification Section, verify section: 'Proper Shipping Name' contains value: Choose...
...
And In the International Air Transport (IATA) Classification Section, set the option in section: 'Proper Shipping Name': to: Aerosols, flammable
#And Hazard Class (select) should be showing the value: 2.1
And In the International Air Transport (IATA) Classification Section, verify section: 'Hazard Class (select)' contains value: 2.1
...
And In the International Air Transport (IATA) Classification Section, set the option in section: 'Proper Shipping Name': to: Aerosols, non-flammable, containing substances in Division 6.1, Packing Group III
#And Hazard Class (select) should be showing the value: 2.2
And In the International Air Transport (IATA) Classification Section, verify section: 'Hazard Class (select)' contains value: 2.2
...
And In the International Air Transport (IATA) Classification Section, verify section: 'UN Number' contains value: UN1966
#And Proper Shipping Name should be showing the value: Hydrogen, refrigerated liquid
And In the International Air Transport (IATA) Classification Section, verify section: 'Proper Shipping Name' contains value: Hydrogen, refrigerated liquid
#And Technical Name should be showing the value: Technical Name Test
And In the International Air Transport (IATA) Classification Section, verify section: 'Technical Name (if applicable)' contains value: Technical Name Test
#And Hazard Class (select) should be showing the value: 2.1
And In the International Air Transport (IATA) Classification Section, verify section: 'Hazard Class (select)' contains value: 2.1
