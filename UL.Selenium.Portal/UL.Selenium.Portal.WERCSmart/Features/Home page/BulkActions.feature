...
Scenario: [75129] Forward - Product in Submitted Status
	...
	Then I select one of the following retailers that is not in the list saved as: TestCase75129Retailers from the table: and saved the chosen retailer as: TestCase75129Retailer
	| Retailer                                                                       |
