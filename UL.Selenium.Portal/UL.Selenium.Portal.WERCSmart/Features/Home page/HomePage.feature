...
| Retailer  |
| Walgreens |
Given I call Shared Step 158500 (Enter Universal Product Code (UPC) - Battery - Confirm SKU - Do Not Click Continue) for UPC saved as: UPC158930 with container type: Metal Container size: 2 and SKU: RandomSKU158930
...
@philtag2
@ScenarioId:10755
Scenario: [1589301] Home Page Search - Internal Information

Given I call Shared Step 67823 (Login to WERCSmart - Products Automation Account)
Given I generate a random UPC number and save as: UPC1589301
Given I generate a random Product ID and save as: ProductID1589301
Then Generate a random SKU number (12 random digits) and save as: RandomSKU1589301
Given I call Shared Step 57408 (Create a New Registration via Register New Product icon)
Given I set the Product Identification (Optional) field to Proudct ID saved as: ProductID1589301
Given I call Shared Step 57500 (The Product- Enter name, select product type - Continue - Happy Path): Chalk
Given I save the product information as: TestCase1589301
Given I call Shared Step 26897 (Product Characteristics - Solid only available - continue)
Given I call Shared Step 59680 (Additional Product Information - US only, No Child, No GHS, No Direct Ship, No PLP, No GNFR - Continue - Happy Path)
Given I generate a random Ingredient ID and save as: IngredientID1589301
Given In the Ingredient Reference Number field I enter the following text: IngredientID1589301 and saved as: IngID1
Given I call Shared Step 29181 (Ingredients - add any chemical) with name: Water
Given I should see the Waste Classification Data Page
Given I call Shared Step 57503 (Regulatory Information 1- TSCA(Random) - Prop 65(No) - Continue - Happy Path)
Given I call Shared Step 75146 (Retailer - Select one or more retailers that do not require vendor ID or additional UPC information, Click Done, Click Continue) for
| Retailer  |
| Walgreens |
Given I call Shared Step 158500 (Enter Universal Product Code (UPC) - Battery - Confirm SKU - Do Not Click Continue) for UPC saved as: UPC1589301 with container type: Metal Container size: 2 and SKU: RandomSKU1589301
Given in the Universal Product Code (UPC) page I click Continue
Given I call Shared Step 57881 (Regulatory Documents to Provide - US only - request authoring - Happy Path)
Given in the Additional Documents to Provide page I click Continue
Given in the Optional Reports and Documents Available for Purchase page I click Continue
...
Given I click More Filters in the products grid
Given I confirm I see the Product ID, Ingredient ID, SKU field above the Product Grid
Given In the Product ID, Ingredient ID, SKU filter field I search for: ProductID1589301
Given I should only see one product in the grid, with Product ID matching that saved as: ProductID1589301
Given I clear the Search Criteria
Given I click More Filters in the products grid
Given In the Product ID, Ingredient ID, SKU filter field I search for: IngID1
Given I should only see one product in the grid, with Product ID matching that saved as: ProductID1589301
Given I clear the Search Criteria
Given I click More Filters in the products grid
Given In the Product ID, Ingredient ID, SKU filter field I search for: RandomSKU1589301
Given I should only see one product in the grid, with Product ID matching that saved as: ProductID1589301
Given I clear the Search Criteria
Given I click More Filters in the products grid
