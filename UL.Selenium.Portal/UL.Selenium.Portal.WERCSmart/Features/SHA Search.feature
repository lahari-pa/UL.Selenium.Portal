...
@SHASearch
# QA Test needs UPC 5000171007186, Sprint 2 needs UPC 0046442718103
Scenario: [110399] SHA Manager - Search UPC for Archived Registration - Verify Popup
	Given I call Shared Step 65080 (Login to Studio and Open SHA manager)
	Then SHA Search for product by UPC: 5000171007186 in all statuses
	Given I verify the popup message displays with the title "Archived Product / Archived UPC"
	Then I verify the popup data using UPC: 5000171007186
