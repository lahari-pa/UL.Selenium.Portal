...
#line hidden
        ...
        public virtual void TestInitialize()
        {
            if (((TechTalk.SpecFlow.FeatureContext.Current != null) 
                        && (TechTalk.SpecFlow.FeatureContext.Current.FeatureInfo.Title != "Retailer Partners")))
            {
                Wercs.Selenium.PortalUX.Features.RetailerPartnersFeature.FeatureSetup(null);
            }
        }
