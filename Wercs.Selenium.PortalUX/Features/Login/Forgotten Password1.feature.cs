...
#line 48
testRunner.Then("there should be a new email for user: ForgotPasswordUser from: <SiteNotification>" +
                    " with the title: WERCSmart Password Reset", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 49
...
testRunner.When("I click the continue button in the Forgotten Password window", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 58
testRunner.Then("there should not be a new email for user: EmailValidation from: <SiteNotification" +
                    "> with the title: WERCSmart Password Reset", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 59
testRunner.Then("In the Forgotten Password window I should see the following error messages: Email" +
