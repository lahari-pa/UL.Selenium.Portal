...
namespace Wercs.Selenium.PortalUX.Steps
{
	...
	{
		[StepDefinition(@"I create a product using Test Case 75335 \(SOLD set to US only with Walmart as retailer\) and save as: (.*)")]
		public void CreateProductUsingTestCase75335(string savedAs)
		{
			...
			sharedSteps.GivenICallSharedEnterUniversalProductCodeUPC_UPC_ContainerType_SizeOnly("saved as UPC75335", "Metal Container", "40");
