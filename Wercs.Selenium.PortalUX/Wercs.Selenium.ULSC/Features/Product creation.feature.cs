...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ULSC Product creation", "", ProgrammingLanguage.CSharp, new string[] {
                        "Login",
                        "UlSolutionCenter",
                        "Homepage",
                        "ProductGrid",
        ...
        public virtual void _88606ULSCAutomationUser_CreateInPortalANewSimpleProductChalkAndSubmitThruToCompletedStatusNGHSOnly()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("[88606] ULSC Automation user - Create (in Portal) a new simple product (Chalk) an" +
                    "d submit thru to Completed status (NGHS only)", ((string[])(null)));
#line 25
